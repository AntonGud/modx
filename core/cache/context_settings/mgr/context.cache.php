<?php  return array (
  ...
  array (
    ...
    array (
      ...
      'name' => 'lowercaseUrl',
      'description' => 'Для передресации сылок с прописными буквами на строчные',
      'editor_type' => '0',
      'category' => '8',
      'cache_type' => '0',
...
switch($eventName) {
    ...
    array (
      ...
      'description' => 'Для передресации по нужному протоколу http или https исходя из настроек',
      'editor_type' => '0',
      'category' => '8',
      'cache_type' => '0',
      'plugincode' => '$eventName = $modx->event->name;
